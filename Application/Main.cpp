...
int main(int argc, char** argv)
{
   ...
   /* nc::SeedRandom(static_cast<unsigned int>(time(nullptr)));
    ...
    ////unifrom
    //GLuint location = glGetUnifromLoaction(sahderProgram, "scale");
    //float time = 0;

    //GLuint tintLocation = glGetUnifromLoaction(sahderProgram, "tint");
